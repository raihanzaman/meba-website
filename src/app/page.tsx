            ...
            <div className="meba-card p-6">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-[#d4af37] rounded-lg flex items-center justify-center mr-4">
                  <span className="text-[#1a4d3a] font-bold">16</span>
                </div>
                <div>
                  <p className="text-sm text-[#2d5a47] font-medium">April</p>
                  <p className="text-lg font-bold text-[#1a4d3a]">Fireside Chat with Ishana Nigam</p>
                </div>
              </div>
              <h3 className="font-semibold text-[#1a4d3a] mb-2">Room: UC-15</h3>
              <p className="text-gray-600 text-sm mb-4">Join us for a fireside chat with Ishana Nigam, Stern alum and McKinsey associate!</p>
            </div>
